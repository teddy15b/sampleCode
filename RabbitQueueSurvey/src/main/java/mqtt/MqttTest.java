...
public class MqttTest extends TestCase implements MqttCallback {
    ...
    private void setConOpts(MqttConnectOptions conOpts) {
        ...
        conOpts.setUserName("dap");
        conOpts.setPassword("dapisno1".toCharArray());
    ...
    public void testConnectFirst() throws MqttException, IOException, InterruptedException {
        ...
        networkModule.start();
        MqttInputStream  mqttIn  = new MqttInputStream (null, networkModule.getInputStream());
        MqttOutputStream mqttOut = new MqttOutputStream(null, networkModule.getOutputStream());
        try {
